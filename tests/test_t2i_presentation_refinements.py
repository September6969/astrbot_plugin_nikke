...
# ==============================================================================
# 1. CHARACTER OL SUMMARY OVERFLOW & DENSITY ADAPTATION (SUPERSEDED BY REPLICA CARD)
# ==============================================================================

@pytest.mark.skip(reason="superseded by replica character card (1600x2400) architecture")
