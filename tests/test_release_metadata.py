...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_schema_defaults_and_configuration_document_are_complete(self):
        ...
        expected = {
            ...
            "spine_worker_path_4_1": ("string", ""),
            "spine_runtime_version": ("string", "4.0"),
            "spine_worker_timeout": ("int", 4),
            "nikke_db_local_root": ("string", ""),
            "spine_runtime_cache_dir": ("string", ""),
            "spine_runtime_meta_dir": ("string", ""),
            "spine_auto_warm_enabled": ("bool", True),
            "nikke_db_remote_fetch_enabled": ("bool", True),
