...
更新时间：2026-09-09。当前核验的远端基线为 `origin/main@a34f6fc`；下表是本轮工作索引。工作树可能继续变化，恢复前必须运行 `git worktree list`、逐树 `git status`，并以远端 PR/CI 为权威。
...
| Live RC Character localization v1 | 当前独立主题 | `E:\DevCache\nikke-live-rc-localization-20260909` / `feat/live-rc-character-localization-v1`；从 `origin/main@a34f6fc` 建立，统一目录身份字段与 Arcana 查询 alias |
