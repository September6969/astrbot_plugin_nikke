...
| `E:\_codex_work\asset-prefetch-lifecycle-v1-worktree\astrbot_plugin_nikke` | `feat/asset-prefetch-lifecycle-v1` | AssetManager bounded prefetch lifecycle | Draft PR #38；head `85d1b85`；CI `34141290303` 运行中；与 PR #17/#37 均修改 `asset_manager.py`，需合并时协调；工作树 clean |
