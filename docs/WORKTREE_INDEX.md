...
| `E:\_codex_work\live-evidence-register-v1-worktree\astrbot_plugin_nikke` | `docs/live-evidence-register-v1` | Authorized live-evidence register | Draft PR #39；head `9877fc9`；CI `34142711091` 运行中；只记录现场证据最小动作，不执行账号/消息/部署操作；工作树 clean |
