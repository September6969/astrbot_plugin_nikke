...
| `E:\_codex_work\astrbot_plugin_nikke` | `feat/runtime-config-hardening` | Runtime configuration and scheduler boundary hardening | Draft PR #20；head `e0ac0c8`；CI `34101656392`；工作树 clean |
