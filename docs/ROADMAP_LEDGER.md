...
- `serv` 隔离维护证据：Nikke-db source commit `a2358b72bd1335c30737e46482a99947f3788bc7`，200 默认 + 40 已核验 Costume，共 240 项，runtime 4.0/4.1 为 102/138；补齐精确 sparse Costume bundle 并通过禁网 Docker worker 桥接后，渲染成功 240、失败 0、无效 0、缺失 0，default/costume/overall coverage 均为 100%。全量完整性复核无异常，20 张五企业/runtime/Costume 接触表已实际查看；不把该隔离结果冒充生产部署。
