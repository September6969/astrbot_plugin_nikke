...
| #35 | `feat/daily-result-contract-v1` | Structured DailyTaskResult status contract | OPEN / Draft / CI green；head `5c7505d`；CI `34168254224` 四项全绿（Node、Python 3.10–3.12） |
