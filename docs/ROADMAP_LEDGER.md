...
| #13 | `feat/voice-mapping-v2` | Voice mapping public research | OPEN / Draft / CI green（最终现场核验） |

## 当前推进

| 主题 | 分支 | 基线 | 状态 |
| --- | --- | --- | --- |
| Voice mapping public research | `feat/voice-mapping-v2` | `bada0b3` | Draft PR #13；当前 head CI 已全绿（最终现场核验） |
